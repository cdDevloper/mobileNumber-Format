//
//  GetDashboardRFIDListProxy.swift
//  LYNKD
//
...
class GetDashboardRFIDListProxy: AbstractProxy {
    
    func GetDashboardRFIDList(_ baseUrl: String,
        ...
        return self.GET(baseUrl, postData: postData, requestName: RequestName.getmasterrfids)!
    }
    
    override func successCallback(_ response: AnyObject, headers: [AnyHashable : Any], requestName: String) {
        
        if requestName == RequestName.getmasterrfids {
