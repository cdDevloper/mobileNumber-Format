//
//  UpdateBatteryLevelProxy.swift
//  LYNKD
//
//  Created by Pavan Jadhav on 09/12/17.
...
class UpdateBatteryLevelProxy: AbstractProxy {
    
    func updateBatteryLevel(_ baseUrl: String,
        ...
        return self.GET(baseUrl, postData: postData, requestName: RequestName.UpdateBatteryLevel)!
    }
    
    override func successCallback(_ response: AnyObject, headers: [AnyHashable : Any], requestName: String) {
        
        if requestName == RequestName.UpdateBatteryLevel {
