//
//  GetDashboardUserListProxy.swift
//  LYNKD
//
...
class GetDashboardUserListProxy: AbstractProxy {
    
    func GetDashboardUserList(_ baseUrl: String,
        ...
        return self.GET(baseUrl, postData: postData, requestName: RequestName.getmasterusers)!
    }
    
    override func successCallback(_ response: AnyObject, headers: [AnyHashable : Any], requestName: String) {
        
        if requestName == RequestName.getmasterusers {
