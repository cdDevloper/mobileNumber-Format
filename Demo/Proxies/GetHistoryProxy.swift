...
class GetHistoryProxy: AbstractProxy {
    
    func getHistoryList(_ baseUrl: String,
        ...
        return self.GET(baseUrl, postData: postData, requestName: RequestName.GetDeviceHistoryList)!
    }
    
    override func successCallback(_ response: AnyObject, headers: [AnyHashable : Any], requestName: String) {
        
        if requestName == RequestName.GetDeviceHistoryList {
